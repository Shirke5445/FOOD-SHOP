...
import { useGetProductsDetailsQuery } from '../../redux/api/productsApi.js';
import toast from 'react-hot-toast';
import Loader from '../layout/Loader.jsx';
import StarRatings from 'react-star-ratings';
import { useDispatch } from 'react-redux';
import { setCartItem } from '../../redux/features/cartSliece.js';
...
const ProductDetails = () => {
  ...
  const increseQty = () => {
    const count = document.querySelector(".stockCounter input");
...
const setItemToCart = () => {
    const cartItem = {
      ...
      image: product?.images && product.images.length > 0 ? product.images[0].url : '',
       // Provide a default value if image is not available
      stock: product?.stock,
      quantity
    };
